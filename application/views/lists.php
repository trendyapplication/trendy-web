    ...
    <table class="table table-bordered table-hover"> 
        <thead>
            ...
            <tr>
                ...
                <th colspan="2"><span class="link_blak" ><center> Actions</center></span></th>
                <th width="70">Name</th>
                <th width="60">Brand</th>
                <th width="60">Description</th>
                <th width="60">Occasion Name</th>
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                ...
                <td><a href="<?php echo base_url(); ?>admin/post/details/<?php echo $val->id; ?>" class="link1"><?php echo stripslashes($val->product_name) ?> </a></td>
                <td><?= $val->brand; ?></td>
                 <td width="100"><?= $val->description; ?></td>
                <td><?= $val->occasion_name; ?></td>
                <td><?= $val->category_name; ?></td>
                <td><?= $val->price; ?></td>
                <td><img src="<?= base_url() ?>uploads/thumbs/post/<?= $val->fileNAME; ?>" height="140" style="max-width: 200px !important" ></td>
                <td><?= $val->user_name; ?></td>
