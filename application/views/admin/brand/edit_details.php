                ...
                <fieldset>
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            ...
                            <input type="text" name="name" value="<?php echo isset($brand['brand']) ? $brand['brand'] : ''; ?>" placeholder="brand_name"  required class="form-control" >
                    ...
                    <div class="form-group">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="email" style="cursor: auto" value="<?php echo isset($brand['update_on']) ? date(getConfigValue('date_format'), strtotime($brand['update_on'])) : ''; ?>" placeholder="Updated on" class="form-control"  readonly="readonly" >
