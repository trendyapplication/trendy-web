<script language="javascript">
    ...
    function toggleStatus(id, status, statusdiv) {
        $.ajax({
            url: "<?php echo base_url() ?>admin/brand/ajaxstatus",
    ...
    function toggleblock(id, block, blockdiv) {
        $.ajax({
            url: "<?php echo base_url() ?>admin/brand/ajaxblock",
...
// function to delete masteraction 
        $("#deleteSel").click(function () {
            ...
            if (confirm('Are you sure to delete the selected occasio(s)?')) {
                $("#userMasterForm").attr("action", "<?php echo site_url("admin/brand/index"); ?>");
...
// function to delete product 
        $("#bulkaction").change(function () {
            ...
            if (chkCnt == 0) {
                ...
                if (confirm('Are you sure to delete the selected user(s)?')) {
                    $("#userMasterForm").attr("action", "<?php echo site_url("admin/brand/bulkAction"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                }
                else {
        ...
        $('.sortlink').click(
                function () {
                    ...
                    $("#userMasterForm").attr("action", "<?php echo site_url("admin/brand/lists"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                });
        ...
        $(document).on('change', '#limit', function () {
            $("#userMasterForm").attr("action", "<?php echo base_url("admin/brand"); ?>");
            $("#userMasterForm").submit();
            return true;
        });
        ...
        $('#btn_search').click(
                function () {
                    $("#userMasterForm").attr("action", "<?php echo site_url("admin/brand/"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                });
...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/brand">
    ...
    <div class="row" id="Title">
        <div class="col-lg-12"><legend>Brand</legend></div>
    </div>
    ...
    <div class="row form-group">
        <div class="col-lg-6">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn btn_search">
                    <a href="javascript:" onclick="window.location.href = '<?php echo base_url() ?>admin/brand/index'" class="blu_btn">
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                <?php foreach ($userlist as $val) : ?>
                    <tr>
                        <td width="5"><center><a href="<?php echo base_url(); ?>admin/brand/delete/<?php echo $val->id; ?>?limit=<?php echo $limit; ?>&per_page=<?php echo $per_page; ?>" onclick="return confirm('Are you sure you want to delete? If this brand deleted , all datas belonging to this brand will be deleted ');"><i class="glyphicon glyphicon-trash" title="Delete"></i></a></center></td>
                <td width="5"><center>

                    <a href="<?php echo base_url(); ?>admin/brand/details/<?php echo $val->id; ?>" class="link1">
                        <i class="glyphicon glyphicon-eye-open" title="View Details"></i></a></center>
                </td>
                <td width="5"><center>

                    <a href="<?php echo base_url(); ?>admin/brand/editdetails/<?php echo $val->id; ?>" class="link1">
