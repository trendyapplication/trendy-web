...
// function to delete product 
        ...
        $('.sortlink').click(
                function () {
                    ...
                    $("#userMasterForm").attr("action", "<?php echo base_url("country/country_list"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                });
        ...
        $(document).on('change', '#limit', function () {
            $("#userMasterForm").attr("action", "<?php echo base_url("admin/country/country_list"); ?>");
            $("#userMasterForm").submit();
            return true;
        });
...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/country/country_list">
    ...
    <div class="row" id="Title">
        <div class="col-lg-12"><legend>country</legend></div>
    </div>
    ...
    <div class="row form-group">
        <div class="col-lg-8">
            ...
            <div class="input-group"  >
                ...
                <span class="input-group-btn btn_search">
                    <a href="javascript:" onclick="window.location.href = '<?php echo site_url() ?>/admin/country/country_list'" class="blu_btn">
                        <button class="btn btn-default" type="button">Reset</button></a>
                </span>
               <span class="input-group-btn btn_search" >
                    <a href="javascript:" onclick="window.location.href = '<?php echo site_url() ?>/admin/country/editdetails'" class="blu_btn">
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                <?php foreach ($userlist as $val) : ?>
                    <tr>
                        <td width="53"><center><a href="<?php echo site_url(); ?>/admin/country/delete/<?php echo $val->id; ?>?limit=<?php echo $limit; ?>&per_page=<?php echo $per_page; ?>" onclick="return confirm('Are you sure you want to delete? If this country deleted , all datas belonging to this country will be deleted ');"><i class="glyphicon glyphicon-trash" title="Delete"></i></a></center></td>
               
              <td width="67"><center>

                    <a href="<?php echo site_url(); ?>/admin/country/editdetails/<?php echo $val->id; ?>" class="link1">
