...
// function to delete product 
        ...
        $(document).on('change', '#limit', function () {
            $("#userMasterForm").attr("action", "<?php echo base_url("admin/state_gn/city_list"); ?>");
            $("#userMasterForm").submit();
            return true;
        });
...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/state_gn/city_list">
    ...
    <div class="row form-group">
        <div class="col-lg-6">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn btn_search">
                    <a href="javascript:" onClick="window.location.href = '<?php echo site_url() ?>/admin/state_gn/city_list'" class="blu_btn">
                        <button class="btn btn-default" type="button">Reset</button></a>
                </span>
                  <span class="input-group-btn btn_search" >
                    <a href="javascript:" onClick="window.location.href = '<?php echo site_url() ?>/admin/state_gn/edit_statedetails'" class="blu_btn">
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                <?php foreach ($userlist as $val) : ?>
                    <tr>
                        <td width="53"><center><a href="<?php echo site_url(); ?>/admin/state_gn/delete_state/<?php echo $val->state; ?>?limit=<?php echo $limit; ?>&per_page=<?php echo $per_page; ?>" onClick="return confirm('Are you sure you want to delete? If this city deleted , all datas belonging to this city will be deleted ');"><i class="glyphicon glyphicon-trash" title="Delete"></i></a></center></td>
               
              <td width="67"><center>

                    <a href="<?php echo site_url(); ?>/admin/state_gn/edit_statedetails/<?php echo $val->id; ?>" class="link1">
