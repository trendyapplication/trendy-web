...
<div class="clearfix">&nbsp;</div>
            ...
            <form class="form-horizontal" role="form" action="" method="post">
                <fieldset>
                    ...
                    <div class="form-group">
                        <label class="col-sm-2 control-label" for="textinput">State Name</label>

                        <div class="col-sm-10">

                            <input type="text" name="state_name" value="<?php echo isset($brand['state_name']) ? $brand['state_name'] : ''; ?>" placeholder="state"  required class="form-control" >
 ...
 <div class="form-group">
  ...
  <?php }?>
                    ...
                    <!-- Text input-->
                    <div class="form-group">
                      <label class="col-sm-2 control-label" for="textinput">State Code</label>
                        <div class="col-sm-10">
                          
                           <input type="text" name="state_code" value="<?php echo isset($brand['state']) ? $brand['state'] : ''; ?>" placeholder="state code"  required class="form-control" >
                        </div>
