...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/occasion/lists">
    ...
    <table class="table table-bordered table-hover"> 
        ...
        <th colspan="3"><span class="link_blak" ><center> Actions</center></span></th>
        <th width="70">Name</th>
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                ...
                <td><?php if( $val->image!=''){ ?>
                    <a href="<?php echo base_url(); ?>admin/occasion/details/<?php echo $val->occasion_id; ?>" class="link1"><img src="https://s3.amazonaws.com/trendyservice/occasion/<?= $val->image; ?>" width="165" height="120"></a>
                <?php } else{ ?>
                    <a href="<?php echo base_url(); ?>admin/occasion/details/<?php echo $val->occasion_id; ?>" class="link1"><img src="<?= base_url() ?>uploads/no-image340.png" width="165" height="120"></a>
