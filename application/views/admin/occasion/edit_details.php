...
//                        alert("sdhh");
            ...
            onComplete: function (file, response) {
                ...
                if (response.indexOf("error") > -1) {
                    ...
                    var d = new Date();
                    $("#img_pic").attr('src','https://s3.amazonaws.com/trendyservice/occasion/' + response.trim() + "?" + d.getTime());
                ...
                <div class="col-lg-12">
                    <div id="im2">
                        <?php if ($occasion['image'] != '') { ?>
                            <img src="https://s3.amazonaws.com/trendyservice/occasion/<?= $occasion['image']; ?>" id="img_pic" width="165" height="130" />
                        <?php } else { ?>
