...
// function to delete masteraction 
        $("#deleteSel").click(function () {
            ...
            if (confirm('Are you sure to delete the selected occasio(s)?')) {
                $("#userMasterForm").attr("action", "<?php echo site_url("admin/occasion/index"); ?>");
...
// function to delete product 
        $("#bulkaction").change(function () {
            ...
            if (chkCnt == 0) {
                ...
                if (confirm('Are you sure to delete the selected user(s)?')) {
                    $("#userMasterForm").attr("action", "<?php echo site_url("admin/occasion/bulkAction"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                }
                else {
        ...
        $('.sortlink').click(
                function () {
                    ...
                    $("#userMasterForm").attr("action", "<?php echo site_url("admin/occasion/lists"); ?>");
                    $("#userMasterForm").submit();
                    return true;
                });
...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/occasion/lists">
    ...
    <div class="row" id="Title">
        <div class="col-lg-12"><legend>Occasion Lists</legend></div>
    </div>
    ...
    <div class="row form-group">
        ...
        <div class="col-lg-6">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn btn_search">
                    <a href="javascript:" onclick="window.location.href = '<?php echo base_url() ?>admin/occasion/index'" class="blu_btn">
    ...
    <table class="table table-bordered table-hover"> 
        ...
        <th colspan="4"><span class="link_blak" ><center> Actions</center></span></th>
        <th width="70">Name</th>
        ...
        <tbody>
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                ...
                <td width="5"><center><a href="<?php echo base_url(); ?>admin/occasion/bulkAction/delete/<?php echo $val->occasion_id; ?>?limit=<?php echo $limit; ?>&per_page=<?php echo $per_page; ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="glyphicon glyphicon-trash" title="Delete"></i></a></center></td>


                <td width="5"><center>

                    <a href="<?php echo base_url(); ?>admin/occasion/details/<?php echo $val->occasion_id; ?>" class="link1">
                        <i class="glyphicon glyphicon-eye-open" title="View Details"></i></a></center>
                </td>
                 <td width="5"><center>

                    <a href="<?php echo base_url(); ?>admin/occasion/editdetails/<?php echo $val->occasion_id; ?>" class="link1">
                        <i class="glyphicon glyphicon-edit" title="Edit Details"></i></a></center>
                </td>
                <td width="51"><div id="div_status_<?php echo $val->occasion_id; ?>"> <center> <a href="javascript:void(0)" >

                                <?php if ($val->is_block == 'N') { ?>
                                    <i class="glyphicon glyphicon-unlock"  title="Block" onclick="toggleblock('<?php echo $val->occasion_id; ?>', '<?php echo $val->is_block; ?>', '#div_block_<?php echo $val->occasion_id; ?>')" id="star_block_<?php echo $val->occasion_id; ?>" ></i>
                                <?php } else { ?>
                                    <i  class="glyphicon glyphicon-remove"   title="Unblock" onclick="toggleblock('<?php echo $val->occasion_id; ?>', '<?php echo $val->is_block; ?>', '#div_block_<?php echo $val->occasion_id; ?>')" id="star_block_<?php echo $val->occasion_id; ?>" ></i>
                                <?php } ?>
                            </a></center></div></td>
                    <!--<td><div id="div_status_<?php echo $val->occasion_id; ?>"> <center> <a href="javascript:void(0)" >
                <?php if ($val->status == 'Y') { ?>
                                                                <i class="glyphicon glyphicon-star"  title="Inactive" onclick="toggleStatus('<?php echo $val->occasion_id; ?>','<?php echo $val->status; ?>','#div_status_<?php echo $val->occasion_id; ?>')" id="star_active_<?php echo $val->occasion_id; ?>" ></i>
                <?php } else { ?>
                                                                <i  class="glyphicon glyphicon-star-empty"   title="Active" onclick="toggleStatus('<?php echo $val->occasion_id; ?>','<?php echo $val->status; ?>','#div_status_<?php echo $val->occasion_id; ?>')" id="star_active_<?php echo $val->occasion_id; ?>" ></i>
                <?php } ?>
                                            </a></center></div></td>-->
                <td><a href="<?php echo base_url(); ?>admin/occasion/details/<?php echo $val->occasion_id; ?>" class="link1"><?php echo stripslashes($val->name) ?> </a></td>

                <td><a href="<?php echo base_url(); ?>admin/occasion/details/<?php echo $val->occasion_id; ?>" class="link1"><img src="<?= base_url() ?>uploads/thumbs/occasion/<?= $val->image; ?>" width="165" height="120"></a></td>

                <td><?php echo date(getConfigValue('date_format'), strtotime($val->inserted_on)); ?>
                </td>
