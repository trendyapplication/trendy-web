...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/report/lists">
    ...
    <div class="row" id="Title">
        <div class="col-lg-12"><legend>Report Lists</legend></div>
    </div>
    ...
    <div class="row form-group">
        <div class="col-lg-6">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn btn_search">
                    <a href="javascript:" onclick="window.location.href = '<?php echo base_url() ?>admin/report/index'" class="blu_btn">
            ...
            <?php if (sizeof($userlist) > 0) : //echo "<pre>"; print_r($userlist); exit;  ?>
                <?php foreach ($userlist as $val) : ?>
                    ...
                    <tr>
                        ...
                        <td width="5"><center><a href="<?php echo base_url(); ?>admin/report/delete/<?php echo $val->id; ?>?limit=<?php echo $limit; ?>&per_page=<?php echo $per_page; ?>" onclick="return confirm('Are you sure you want to delete?');"><i class="glyphicon glyphicon-trash" title="Delete"></i></a></center></td>



                <td><?= $val->content; ?></td>
                <td><?= $val->desc; ?></td>
                <td><a href="<?= base_url() ?>admin/post/details/<?=$val->product_id ?>" target="_blank">View Product</a></td>

                <td><?= $val->user_name ?></td>

                <td><?php echo date(getConfigValue('date_format'), strtotime($val->reported_on)); ?>
                </td>
