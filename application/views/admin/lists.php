...
<form name="userMasterForm" id="userMasterForm" method="post" action="<?php echo base_url(); ?>admin/brand/lists">
        ...
        <div class="col-lg-6">
            ...
            <div class="input-group">
                ...
                <span class="input-group-btn btn_search">
                    <button class="btn btn-info " id="btn_search" type="submit">Go!</button>
                </span>
                <span class="input-group-btn btn_search">
