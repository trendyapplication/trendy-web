...
//            echo "s";    
    ...
    function uploadImage() {
        if ($_FILES['ocimage']['name'] != '') {
            ...
            $targetFile = realpath('uploads/thumbs/occasion') . "/" . $new_file_name;
            shell_exec("/usr/local/bin/s3cmd  --config=/var/www/html/trend/.s3cfg     --acl-public put " . $targetFile . "    s3://trendyservice/occasion/");
            $this->user_model->setTable("occasion_master");
