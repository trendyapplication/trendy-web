...
class Client2tst extends CI_Controller {
    ...
    public function index() {
     ...
     $json='{"function":"filter_live_trend","parameters": {"v": "1.0","apv": "I-1.0","authKey": "9c833a407cbbf0e2ab7c9ca9fca744a3","sessionKey": "P3eEKbKSXarDW58K20p0","user_id": "454","sel_type": "brand","category": "","brand": "169","pop_start": "20","pop_end": "21","price_start": "0","price_end": "1","lat": "12.9715987","long": "77.5945627"},"token":""}';
...
//        shell_exec("/usr/local/bin/s3cmd --config=/var/www/html/trendyservice/.s3cfg --acl-public put " . $targetFile . "    s3://trendyservice/members/");
        ...
        $result = array('status' => 'true', 'width' => $width, 'height' => $height, 'message' => "image update successfully", 'img_url' => "https://s3.amazonaws.com/trendyservice/members/" . $imagename . "?" . uniqid());
        echo json_encode($result);
    }
...
//        $user_id = $arr['user_id'];
        ...
        $brandss = $this->users_model->get_brand_full($city, $gender);
...
//        $result = array('status' => 'true','response'=>$g, 'message' => "Succesfully updated");
    ...
    function filter_occasion($arr) {
        ...
        $brands = $this->users_model->get_brand_full_occasion($city, $gender, $occasion_id);
