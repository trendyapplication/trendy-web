...
class Client2tst extends CI_Controller {
    ...
    public function index() {
        ...
        $json=' {"function":"filter_live_trend","parameters": {"v": "1.0","apv": "I-1.0","authKey": "9c833a407cbbf0e2ab7c9ca9fca744a3","sessionKey": "mtxutROe3jD0mRdZ1PlS","user_id": "454","sel_type": "category","category": "256,259,262","pop_start": "20","pop_end": "29","price_start": "5","price_end": "89","lat": "12.9715987","long": "77.5945627"},"token":""}';
...
//        $user_id = $arr['user_id'];
        ...
        $result = array('status' => 'true', 'message' => "Succesfully updated", 'filter_data' => $data, "brand_list" => $brandss, 'min_max_price_popularity' => $max_min_PricePopularity, "type_list" => $category);
//        $result = array('status' => 'true','response'=>$g, 'message' => "Succesfully updated");
    ...
    function filter_occasion($arr) {
        ...
        $result = array('status' => 'true', 'message' => "Succesfully updated", 'filter_data' => $data, "brand_list" => $brands, 'min_max_price_popularity' => $max_min_PricePopularity, "type_list" => $category);
...
//            $max_min_PricePopularity = $this->users_model->pop_price_status_trend_live($lat, $long, $city, $gender, $user_id);
            $result = array('status' => 'true', "brand_list" => $brand, "type_list" => $category);
        }
        echo json_encode($result);
    }
